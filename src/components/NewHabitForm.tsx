...
export function NewHabitForm() {
  ...
  async function createNewHabit(event: FormEvent) {
    ...
    setTitle("");
    setWeekDays([]);
    alert("Hábito craido com sucesso");
  }
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
      ...
      <input
        ...
        onChange={(event) => setTitle(event.target.value)} //toda vez que usuario escrever algo nesse imput sera anotado na variavel estado
      />
